    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      inlinereturn$3: {
        while (this$2.hasNext__Z()) {
          var a$1 = this$2.next__O();
          var ref = $as_T2(a$1);
          var this$3 = $as_T(ref.$$und1$f);
          if ((this$3 === a$5)) {
            var refExp = new $c_s_Some().init___O(a$1);
            break inlinereturn$3
          }
        };
        var refExp = $m_s_None$()
      };
      if (refExp.isEmpty__Z()) {
        return (NaN)
      } else {
        var temp$expr = this.calculator$Calculator$$getReferenceExpr__T__sci_Map__Lcalculator_Expr($as_T($as_T2(refExp.get__O()).$$und1$f), references);
        var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(a$5));
        expr = temp$expr;
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1) {
    return (function() {
      var x = $uD(delta$1.apply__O());
      return $uD($g.Math.sqrt(x))
    })
  })(delta));
  var sqrtDelta = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, sqrtDelta$1) {
    return (function() {
      if (($uD(sqrtDelta$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(((-$uD(b$2.apply__O())) + $uD(sqrtDelta$1.apply__O())) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - $uD(sqrtDelta$1.apply__O())) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(nam) {
  var jsx$1 = nam.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, nam$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($m_Lcalculator_Calculator$().calculator$Calculator$$getReferenceExpr__T__sci_Map__Lcalculator_Expr($as_T(nam$1.$$und1$f), arg$outer.namedExpressions$1$f), arg$outer.namedExpressions$1$f)
    })
  })(this, nam));
